...
import 'path_drawing_web/path_drawing.dart';
import 'package:flutter_web/services.dart';
import 'flutter_hooks_web/flutter_hooks.dart';
import 'dart:convert';
...
graph(item, a) => flex(
    ...
    1);
line(item, a, color) =>
    sb(150.0, 150.0, CustomPaint(painter: LP(item, io.transform(a), color)));

class LP extends CustomPainter {
  var i;
  var a;
  var color;
  LP(this.i, this.a, this.color);
  void paint(c, s) {
    ...
    ha(x, r) => c.drawPath(p, np()..color = x);
    ha(color, 130.0);
  }
